...
commit;
desc order_kfc;
select sum(total_price) as today_sales from cart_items where status='Delevered' and to_char(order_date,'dd-MM-yyyy')='04-02-2022';
select cart_id,product_id,user_id,product_name,quantity,total_price,status,order_date from cart_items where to_char(order_date,'dd-MM-yyyy')='04-02-2022';